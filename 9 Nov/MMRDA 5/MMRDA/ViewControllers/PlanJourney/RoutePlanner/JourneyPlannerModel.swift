...
struct JourneyPlannerStationDetail : Codable {
    ...
    let decToMetroStationLong : Double?
    let intToStationID : Int?
    let intFromStationTransportMode : Int?
    let intToStationTransportMode : Int?
    let intToStationCode : Int?
    let intFromStationCode : Int?
    let strToStationName : String?
    let startingMYBYKPath : StartingMYBYKPath?
    let isValidStartingMYBYK : Bool?
    let endingMYBYKPath : EndingMYBYKPath?
    ...
    let fareOfFromStationTravel : Int?
    let fareOfToStationTravel : Int?
    let dictFareDetails : DictFareDetails?
    let transportWiseFares : [TransportWiseFares]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case decToMetroStationLong = "decToMetroStationLong"
        case intToStationID = "intToStationID"
        case intFromStationTransportMode = "intFromStationTransportMode"
        case intToStationTransportMode = "intToStationTransportMode"
        case intToStationCode = "intToStationCode"
        case intFromStationCode = "intFromStationCode"
        case strToStationName = "strToStationName"
        case startingMYBYKPath = "startingMYBYKPath"
        case isValidStartingMYBYK = "isValidStartingMYBYK"
        case endingMYBYKPath = "endingMYBYKPath"
        ...
        case fareOfFromStationTravel = "fareOfFromStationTravel"
        case fareOfToStationTravel = "fareOfToStationTravel"
        case dictFareDetails = "dictFareDetails"
        case transportWiseFares = "transportWiseFares"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        decToMetroStationLong = try values.decodeIfPresent(Double.self, forKey: .decToMetroStationLong)
        intToStationID = try values.decodeIfPresent(Int.self, forKey: .intToStationID)
        intFromStationTransportMode = try values.decodeIfPresent(Int.self, forKey: .intFromStationTransportMode)
        intToStationTransportMode = try values.decodeIfPresent(Int.self, forKey: .intToStationTransportMode)
        intToStationCode = try values.decodeIfPresent(Int.self, forKey: .intToStationCode)
        intFromStationCode = try values.decodeIfPresent(Int.self, forKey: .intFromStationCode)
        strToStationName = try values.decodeIfPresent(String.self, forKey: .strToStationName)
        startingMYBYKPath = try values.decodeIfPresent(StartingMYBYKPath.self, forKey: .startingMYBYKPath)
        isValidStartingMYBYK = try values.decodeIfPresent(Bool.self, forKey: .isValidStartingMYBYK)
        endingMYBYKPath = try values.decodeIfPresent(EndingMYBYKPath.self, forKey: .endingMYBYKPath)
        ...
        km = try values.decodeIfPresent(Double.self, forKey: .km)
        fare = try values.decodeIfPresent(Double.self, forKey: .fare)
        isBusOnly = try values.decodeIfPresent(Bool.self, forKey: .isBusOnly)
        ...
        fareOfFromStationTravel = try values.decodeIfPresent(Int.self, forKey: .fareOfFromStationTravel)
        fareOfToStationTravel = try values.decodeIfPresent(Int.self, forKey: .fareOfToStationTravel)
        dictFareDetails = try values.decodeIfPresent(DictFareDetails.self, forKey: .dictFareDetails)
        transportWiseFares = try values.decodeIfPresent([TransportWiseFares].self, forKey: .transportWiseFares)
    }
...
struct TransitPaths : Codable {
    ...
    let strSchDepartureTime : String?
    let strRouteName : String?
    let strSchName : String?
    let strScheduleNo : String?
    let strSchTripStartTime : String?
    let strIcon : String?
    let isChangedMode : Bool?
    let strChangedMode : String?

    enum CodingKeys: String, CodingKey {

        case routeType = "routeType"
        case lstModes = "lstModes"
        case strTransportMode = "strTransportMode"
        case strTransportModeID = "strTransportModeID"
        ...
        case strSchDepartureTime = "strSchDepartureTime"
        case strRouteName = "strRouteName"
        case strSchName = "strSchName"
        case strScheduleNo = "strScheduleNo"
        case strSchTripStartTime = "strSchTripStartTime"
        case strIcon = "strIcon"
        case isChangedMode = "isChangedMode"
        case strChangedMode = "strChangedMode"
    }

    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        routeType = try values.decodeIfPresent(String.self, forKey: .routeType)
        lstModes = try values.decodeIfPresent([String].self, forKey: .lstModes)
        strTransportMode = try values.decodeIfPresent(String.self, forKey: .strTransportMode)
        strTransportModeID = try values.decodeIfPresent(String.self, forKey: .strTransportModeID)
        ...
        strSchDepartureTime = try values.decodeIfPresent(String.self, forKey: .strSchDepartureTime)
        strRouteName = try values.decodeIfPresent(String.self, forKey: .strRouteName)
        strSchName = try values.decodeIfPresent(String.self, forKey: .strSchName)
        strScheduleNo = try values.decodeIfPresent(String.self, forKey: .strScheduleNo)
        strSchTripStartTime = try values.decodeIfPresent(String.self, forKey: .strSchTripStartTime)
        strIcon = try values.decodeIfPresent(String.self, forKey: .strIcon)
        isChangedMode = try values.decodeIfPresent(Bool.self, forKey: .isChangedMode)
        strChangedMode = try values.decodeIfPresent(String.self, forKey: .strChangedMode)
    }

}
struct DictFareDetails : Codable {
    let sCH207 : Int?

    enum CodingKeys: String, CodingKey {

        case sCH207 = "SCH207|1"
    }

    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        sCH207 = try values.decodeIfPresent(Int.self, forKey: .sCH207)
    }

}
struct TransportWiseFares : Codable {
    let fromStation : Int?
    let toStation : Int?
    let individualFare : Int?
    let schNo : String?
    let intTransportID : Int?
    let intRouteID : Int?
    let intServiceTypeID : Int?
    let distance : Double?
    let bReturnJourney : Bool?

    enum CodingKeys: String, CodingKey {

        case fromStation = "fromStation"
        case toStation = "toStation"
        case individualFare = "individualFare"
        case schNo = "schNo"
        case intTransportID = "intTransportID"
        case intRouteID = "intRouteID"
        case intServiceTypeID = "intServiceTypeID"
        case distance = "distance"
        case bReturnJourney = "bReturnJourney"
    }

    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        fromStation = try values.decodeIfPresent(Int.self, forKey: .fromStation)
        toStation = try values.decodeIfPresent(Int.self, forKey: .toStation)
        individualFare = try values.decodeIfPresent(Int.self, forKey: .individualFare)
        schNo = try values.decodeIfPresent(String.self, forKey: .schNo)
        intTransportID = try values.decodeIfPresent(Int.self, forKey: .intTransportID)
        intRouteID = try values.decodeIfPresent(Int.self, forKey: .intRouteID)
        intServiceTypeID = try values.decodeIfPresent(Int.self, forKey: .intServiceTypeID)
        distance = try values.decodeIfPresent(Double.self, forKey: .distance)
        bReturnJourney = try values.decodeIfPresent(Bool.self, forKey: .bReturnJourney)
    }
