...
class ApiRequest:NSObject {
    ...
    func requestPostMethodForMultipart(strurl:String,fileName:String,fileParam:String,fileData:Data?,params:[String:Any],MimeType:String = "image/jpeg", showProgress progres:Bool,completion: @escaping (_ sucess:Bool, _ data:[String:Any]?) -> Void) {
...
//                multipartFormData.append(fileData!, withName:fileParam, fileName:fileName, mimeType: "image/jpeg")
                multipartFormData.append(fileData!, withName:fileParam, fileName:fileName, mimeType:MimeType)
            }
...
//    }
    ...
    func requestPostMethod(strurl:String, params:[String:Any],showProgress progres:Bool,completion: @escaping (_ sucess:Bool, _ data: Data,_ error:String?) -> Void) {
        ...
        print("url",url,params.jsonStringRepresentation)
        if progres {
            SVProgressHUD .show()
