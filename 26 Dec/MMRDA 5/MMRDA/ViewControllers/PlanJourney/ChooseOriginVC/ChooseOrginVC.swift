...
//    var objParent:JourneySearchVC?
    var objParent:NewPlaneJourneyVC?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print(titleName)
        if titleName == "Select From Station"{
            self.callBarButtonForHome(isloggedIn:true,leftBarLabelName:"select_from_location".LocalizedString, isHomeScreen:false,isDisplaySOS: false)
        }else{
            self.callBarButtonForHome(isloggedIn:true,leftBarLabelName:"select_to_location".LocalizedString, isHomeScreen:false,isDisplaySOS: false)
        }
