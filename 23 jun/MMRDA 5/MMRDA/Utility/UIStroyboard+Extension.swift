...
extension UIStoryboard {
    ...
    class func NewPlaneJourneyVC() -> NewPlaneJourneyVC{
        return PlanJourneyStoryBoard().instantiateViewController(withIdentifier: "NewPlaneJourneyVC") as! NewPlaneJourneyVC
    }
    
    class func UpwordNewJourneyVC() -> UpwordNewJourneyVC{
        return PlanJourneyStoryBoard().instantiateViewController(withIdentifier: "UpwordNewJourneyVC") as! UpwordNewJourneyVC
    }
    
    class func SuggestedItineraryVC() -> SuggestedItineraryVC{
        return PlanJourneyStoryBoard().instantiateViewController(withIdentifier: "SuggestedItineraryVC") as! SuggestedItineraryVC
    }
