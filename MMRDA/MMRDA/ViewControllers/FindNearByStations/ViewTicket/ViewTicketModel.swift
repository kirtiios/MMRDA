...
import Foundation
struct ViewTicketModel : Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case intPaymentStatus = "intPaymentStatus"
    ...
    init(from decoder: Decoder) throws {
        ...
        intPaymentStatus = try values.decodeIfPresent(Int.self, forKey: .intPaymentStatus)
