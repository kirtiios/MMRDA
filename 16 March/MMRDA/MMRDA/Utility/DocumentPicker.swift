...
class DocumentPicker: NSObject{
    ...
    func showActionSheet(vc: UIViewController, captureType: MediaType = .document ,  completionBlock: ((Any?) -> Void)?) {
...
extension DocumentPicker: UIDocumentPickerDelegate
{
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
        ...
        {
            let objDoc = docsModel(url: strURL.absoluteString ,docPath: strURL.path, docType: .document)
            docPiked!(objDoc)
            do {
