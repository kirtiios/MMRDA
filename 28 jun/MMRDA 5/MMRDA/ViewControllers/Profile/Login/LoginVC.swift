...
class LoginVC: UIViewController {
    ...
    @IBOutlet var btnPAsswordShowHide:UIButton!
...
//        }
    ...
    @IBAction func btnPAsswordShowHideClick(_ sender: Any) {
        if btnPAsswordShowHide.currentImage == UIImage(named: "passwordHide"){
            textPassword.isSecureTextEntry = false
            btnPAsswordShowHide.setImage(UIImage(named: "passwordShow"), for: .normal)

        }
        else{
            textPassword.isSecureTextEntry = true
            btnPAsswordShowHide.setImage(UIImage(named: "passwordHide"), for: .normal)
        }
    }
    ...
    @IBAction func actionTouchid(_ sender: UIButton) {
        ...
        Helper.shared.authenticationWithTouchID(islogin: true) { sucess in
            if sucess {
