...
extension StationListingVC {
    ...
    func getStationList(time:Int){
       ...
       param["Lattitude"] = LocationManager.sharedInstance.currentLocation.coordinate.latitude
        param["Longitude"] = LocationManager.sharedInstance.currentLocation.coordinate.longitude
        param["Stationid"] = objStation?.stationid
        param["Stationname"] = objStation?.displaystationname
        param["TransportType"] = 1
        param["Distance"] = objStation?.distance
